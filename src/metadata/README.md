 ...
 * [tos-ontology.yml](tos-ontology.yml)
     * Determines how your purl.obolibrary.org/obo/tos-ontology/ redirects will be handled
     ...
     * Paste in the contents of [tos-ontology.yml](tos-ontology.yml)
 ...
 * [tos-ontology.md](tos-ontology.md)
     ...
     * Paste in the contents of [tos-ontology.md](tos-ontology.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
